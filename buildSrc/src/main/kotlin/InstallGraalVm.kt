...
constructor(
  ...
  fun run() {
    ...
    val distroDir = Paths.get(graalVm.get().homeDir.absolutePath, UUID.randomUUID().toString())
    try {
      ...
      val tempLink = Paths.get(graalVm.get().homeDir.absolutePath, UUID.randomUUID().toString())
