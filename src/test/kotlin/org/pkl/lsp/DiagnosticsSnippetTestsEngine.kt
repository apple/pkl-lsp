...
class DiagnosticsSnippetTestEngine : AbstractDiagnosticsSnippetTestEngine() {
...
class WindowsAmd64DiagnosticsSnippetTestsEngine : AbstractNativeDiagnosticsSnippetTestEngine() {
  ...
  override val pathToPklLsp: Path
    get() = FileTestUtils.rootProjectDir.resolve("build/executable/pkl-lsp-windows-amd64")
}
